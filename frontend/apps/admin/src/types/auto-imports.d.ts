...
declare global {
  ...
  const ActionDialog: typeof import('../components/ActionDialog').default
  const Activity: typeof import('react').Activity
  const ExceptionPage: typeof import('../components/ExceptionPage').default
  ...
  const PageHeader: typeof import('../components/PageHeader').default
  const SkyrocAvatar: typeof import('../components/SkyrocAvatar').default
  const StatusBadge: typeof import('../components/StatusBadge').default
